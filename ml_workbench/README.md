...
Classify tutoring questions by STEM subject. This is an optional local training and prediction extension, not an automatic change to live application decisions. The bundled 18-row CSV is synthetic educational data; its scores do not demonstrate real-world accuracy.
...
python -m ml_workbench predict --model ml_workbench/runs/sklearn --text "solve quadratic algebra equations"
```
